...
class Paciente(BaseModel):
    ...
    nombre: str = Field(min_length=3, max_length=50, description="Nombre completo")
    apellido: str = Field(min_length=3, max_length=50, description="Apellido completo")
...
class Cita(BaseModel):
    ...
    motivo: str = Field(min_length=5, max_length=250, description="Motivo de la consulta")
